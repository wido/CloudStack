...
public class MockNetworkModelImpl extends ManagerBase implements NetworkModel {
    ...
    @Override
    public List<String[]> generateVmData(String userData, String serviceOffering, long datacenterId, String vmName, String vmHostName, long vmId, String vmUuid, String guestIpAddress, String guestIp6Address, String publicKey, String password, Boolean isWindows) {
        return null;
    }
